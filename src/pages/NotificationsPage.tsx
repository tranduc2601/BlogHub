          ...
          <div className="flex gap-2">
            {unreadCount > 0 && (
              <button
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-md hover:-translate-y-0.5 cursor-pointer"
              >
