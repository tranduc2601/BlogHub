    ...
    <div className="space-y-12 select-none">
      ...
      <section>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
          ...
          <div className="flex justify-center md:justify-start bg-gray-100 rounded-xl p-1 w-full md:w-auto">
            <button
        ...
        {!loading && !error && (
          <div className={`grid gap-8 ${
            ...
            {filteredPosts.map((post, i) => (
              ...
              >
                <PostCard post={post} onOpenReactionModal={handleOpenReactionModal} />
              </div>
            ))}
          </div>
        )}
