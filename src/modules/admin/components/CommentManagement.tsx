          ...
          filteredComments.map(comment => (
            ...
            >
              <div className="flex justify-between items-start gap-4">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {comment.needsReview && (
                      <span className="px-3 py-1 bg-orange-100 text-orange-700 text-xs font-semibold rounded-full">
                        <i className="fa-solid fa-exclamation mr-2"></i> Cần kiểm duyệt
                      </span>
                    )}
                    {comment.status === 'hidden' && (
                      <span className="px-3 py-1 bg-red-100 text-red-700 text-xs font-semibold rounded-full">
                        <i className="fa-solid fa-ban mr-2"></i> Đã ẩn
                      </span>
                    )}
                  </div>
                ...
                >
                  {comment.status === 'visible' ? <><i className="fa-solid fa-check mr-2"></i> Hiển thị</> : <><i className="fa-solid fa-ban mr-2"></i> Ẩn</>}
                </button>
              </div>
            </div>
          ))
