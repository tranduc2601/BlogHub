          ...
          {!isAuthenticated ? (
            ...
            <div className="relative" ref={profileDropdownRef}>
              <button
                ...
                className="flex items-center gap-3 bg-white border-3 border-blue-500 px-4 py-2 rounded-full font-medium text-blue-900 shadow-md hover:shadow-lg transition-all duration-200 hover:bg-blue-50 cursor-pointer"
              ...
              {showDropdown && (
                <div className="absolute right-[-0.4rem] mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden animate-fadeInDown z-50">
                  ...
                  <div className="py-2">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 transition-all duration-200 group cursor-pointer"
                    >
