...
const PostManagement: React.FC<PostManagementProps> = ({ posts, onToggleStatus, onApprovePost, onRejectPost, onDeletePost, onPendingCountChange }) => {
  ...
  useEffect(() => {
    const fetchPostReactions = async () => {
      ...
      console.log('📊 Post Reactions Map:', reactionsMap);
  ...
  const handleViewPost = async (post: AdminPost) => {
    ...
    try {
      ...
      if (data.success && data.comments) {
        ...
        console.log('📊 Reactions Map:', reactionsMap);
                ...
                {isLoading ? (
                  <div className="flex items-center justify-center py-16">
                    <div className="text-center">
                      ...
                      <p className="mt-6 text-gray-600 font-medium">Đang tải bình luận...</p>
                    </div>
                  </div>
                              ...
                              <div className="relative w-10 h-10 flex-shrink-0">
                                {commentAvatarUrl ? (
                                  <>
                                    ...
                                    />
                                    <div style={{ display: 'none' }} className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 items-center justify-center text-white font-bold">
                            ...
                            {comment.replies.map((reply) => {
                              ...
                              return (
                                <div key={reply.id} className="relative">
                                  ...
                                  <div 
                                    className="absolute left-[-24px] top-0 w-6 border-l-3 border-b-3 rounded-bl-lg"
                                    style={{ 
                                      height: '24px',
                                        ...
                                        <div className="relative w-10 h-10 flex-shrink-0">
                                          {replyAvatarUrl ? (
                                            <>
                                              ...
                                              />
                                              <div style={{ display: 'none' }} className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-teal-600 items-center justify-center text-white font-bold">
