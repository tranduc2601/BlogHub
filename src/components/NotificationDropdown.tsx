  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="group relative flex items-center gap-0 hover:gap-2 transition-all duration-300 hover:scale-105 cursor-pointer"
        title="Thông báo"
      >
        <div className="relative">
          <i className="fa-solid fa-bell text-gray-700 group-hover:text-blue-600 text-lg transition-colors duration-300"></i>
          {unreadCount > 0 && (
        ...
        <span className="max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-300 whitespace-nowrap text-gray-700 group-hover:text-blue-600 font-medium">Thông báo</span>
