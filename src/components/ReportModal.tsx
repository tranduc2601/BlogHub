...
export default function ReportModal({ isOpen, onClose, onSubmit, postTitle }: ReportModalProps) {
      ...
      <div className={`bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl transition-all duration-300 ${
        ...
        <div className="bg-gradient-to-r from-red-500 to-red-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold">Báo cáo vi phạm</h2>
        ...
        <div className="p-6">
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-6">
            <p className="text-sm text-gray-600 mb-1">Bài viết được báo cáo:</p>
            <p className="font-semibold text-gray-800 line-clamp-2">{postTitle}</p>
          </div>
